...
export default function Home() {
  return (
    <main className='flex flex-col items-center justify-between p-8 md:p-24 lg:p-32 bg-white min-h-screen mx-4'>
      <ul className='flex flex-col md:flex-row justify-between items-center rounded-md'>
        <li className='relative w-full lg:w-1/2 flex flex-col items-center md:items-start'>
          <div className='relative max-w-3xl mx-auto text-center md:text-left'>
            <h2 className='text-amber-800 text-4xl lg:text-6xl leading-9 font-semibold mb-4'>Self Confidence and Procrastination</h2>
            <p className='text-gray-600 text-base lg:text-lg md:text-base mb-6'>
